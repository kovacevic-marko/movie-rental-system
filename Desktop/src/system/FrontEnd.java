...
public class FrontEnd extends Application {
	...
	public void start(Stage asd) throws Exception {
		...
		Image img = new Image("file:./Sistem/Pozadine/"+background+".jpg");
...
//MAIN navigation * --------------------------------------------------------------------------------------------------------------------
			Button usersButton = new Button("Users",new ImageView(new Image("file:./Sistem/Ikonice/korisnici/GLAVNA.png")));
			usersButton.setMinSize(120, 35);
			Button moviesButton = new Button("Movies",new ImageView(new Image("file:./Sistem/Ikonice/filmovi/GLAVNA.png")));
			moviesButton.setMinSize(120, 35);
			Button rentalButton = new Button("Rental",new ImageView(new Image("file:./Sistem/Ikonice/iznajmljivanje/GLAVNA.png")));
			rentalButton.setMinSize(120, 35);
			Button propertiesButton = new Button("Properties",new ImageView(new Image("file:./Sistem/Ikonice/podesavanja/GLAVNA.png")));
			propertiesButton.setMinSize(120, 35);
			Button informationsButton = new Button("Informations",new ImageView(new Image("file:./Sistem/Ikonice/informacije/GLAVNA.png")));
			informationsButton.setMinSize(120, 35);
			Button logoutButton = new Button("Logout",new ImageView(new Image("file:./Sistem/Ikonice/odjavi_se/GLAVNA.png")));
...
//Navigation Users * --------------------------------------------------------------------------------------------------------------------
			Button new_userButton = new Button("New user       ",new ImageView(new Image("file:./Sistem/Ikonice/korisnici/novi.png")));
			new_userButton.setMinSize(151, 30);
			Button edit_userButton = new Button("Edit user       " ,new ImageView(new Image("file:./Sistem/Ikonice/korisnici/izmeni.png")));
			edit_userButton.setMinSize(151, 30);
			Button show_userButton = new Button("Show user     ", new ImageView(new Image("file:./Sistem/Ikonice/korisnici/prikazi.png")));
			show_userButton.setMinSize(151, 30);
			Button delete_userButton = new Button("Delete user    ",new ImageView(new Image("file:./Sistem/Ikonice/korisnici/obrisi.png")));
			delete_userButton.setMinSize(151, 30);
			Button show_all_usersButton = new Button("Show all users",new ImageView(new Image("file:./Sistem/Ikonice/korisnici/svi_korisnici.png")));
...
//Navigation Movies ----------------------------------------------------------------------------------------------------------------------
	        Button add_movieButton = new Button("Add movie              ",new ImageView(new Image("file:./Sistem/Ikonice/filmovi/dodaj.png")));
	        add_movieButton.setMinSize(151, 30);
	        Button find_movieButton = new Button("Find movie          ",new ImageView(new Image("file:./Sistem/Ikonice/filmovi/pronadji.png")));
	        find_movieButton.setMinSize(151, 30);
	        Button edit_movieButton = new Button("Edit/Delete movie ",new ImageView(new Image("file:./Sistem/Ikonice/filmovi/izmeni_obrisi.png")));
	        edit_movieButton.setMinSize(151, 30);
	        Button show_all_moviesButton = new Button("Show all movies   ",new ImageView(new Image("file:./Sistem/Ikonice/filmovi/sve.png")));
...
//Navigation Rental * --------------------------------------------------------------------------------------------------------------------
			Button rental_movieButton = new Button("Rental movie   ",new ImageView(new Image("file:./Sistem/Ikonice/iznajmljivanje/iznajmi.png")));
			rental_movieButton.setMinSize(151, 30);
			
			Button return_back_movieButton = new Button("Return back \nmovie ",new ImageView(new Image("file:./Sistem/Ikonice/iznajmljivanje/vrati.png")));
			return_back_movieButton.setMinSize(151, 30);
			
			Button list_of_rental_moviesButton = new Button("List of rental \nmovies",new ImageView(new Image("file:./Sistem/Ikonice/iznajmljivanje/lista.png")));
...
//Navigation Properties * --------------------------------------------------------------------------------------------------------------------
	        Button change_security_codeButton = new Button("Change                  \nsecurity code",new ImageView(new Image("file:./Sistem/Ikonice/podesavanja/sigurnosni_kod.png")));
	        change_security_codeButton.setMinSize(151,30);
	        
	        Button change_backgroundButton = new Button("Change                  \n background",new ImageView(new Image("file:./Sistem/Ikonice/podesavanja/pozadina.png")));
...
//Navigation Informations * --------------------------------------------------------------------------------------------------------------------
	        Button about_programButton = new Button("About program ",new ImageView(new Image("file:./Sistem/Ikonice/informacije/program.png")));
	        about_programButton.setMinSize(151, 30);
	        
	        Button about_authorButton = new Button("About author   ",new ImageView(new Image("file:./Sistem/Ikonice/informacije/autor.png")));
...
//Navigation Properties.Change_background --------------------------------------------------------------------------------------------------------------------
			...
			background1Button.setOnAction( e -> {
				...
				pozadinaIW.setImage(new Image("file:./Sistem/Pozadine/"+background+".jpg"));
			});
...
//Login page -------------------------------------------------------------------------------------------------------------------------------------			
			...
			ImageView security_codeBackground = new ImageView(new Image("file:./Sistem/Pozadine/pocetna.jpg"));
...
//Login Scene and Stage --------------------------------------------------------------------------------------------------------------------------------------------------
			...
			startingStage.getIcons().add(new Image("file:./Sistem/Ikonice/icon.png"));
			startingStage.show();
